...
useUnifiedTopology: true });
 ...
 app.post('/signup', (req, res) => {
    const { name, email,password,phno,gender,age,address,pincode} = req.body;
 // Create a new User document and save it to MongoDB
    const user = new User({ name, email,password,phno,gender,age,address,pincode});
    user.save()
    .then(() => {
    res.send(`<html>
     <body align="center">
...
app.post('/submit', (req, res) => {
    const { name, email, quantity, comments } = req.body;
    res.send(`Thank you for booking ${quantity} copies of the book, ${name}! We'll contact you at ${email}.`);
});
    ...
    app.post('/delete', (req, res) => {
        ...
        User.findOne({ email: emailid }, (err, user) => {
          if (err) {
            ...
            <body align="center">
              ...
              <button><a href="/index">Go Back</a></button><br><br>
            </body>
          </html>
            `);
          }
      ...
      <center><button><a href="/index">Go Back</a></button></center>
      </body>
      </html>`);
          }
        });
